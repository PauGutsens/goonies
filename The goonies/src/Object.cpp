...
Object::Object(const Point& p, ObjectType t) : Entity(p, OBJECT_PHYSICAL_SIZE, OBJECT_PHYSICAL_SIZE, OBJECT_FRAME_SIZE, OBJECT_FRAME_SIZE)
{
	...
	switch (type)
	{
		...
		case ObjectType::PLOMA: rc = { 4 * n, 4 * n, n, n }; break;
		case ObjectType::MELO: rc = { 5 * n, 4 * n, n, n }; break;
...
int Object::Points() const
{
	...
	else if (type == ObjectType::MELO)  return POINTS_MELO;
	else if (type == ObjectType::PLOMA) return POINTS_PLOMA;
	else 
	{
