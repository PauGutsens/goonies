...
AppStatus Player::Initialise()
{
	...
	sprite->AddKeyFrame((int)PlayerAnim::IDLE_RIGHT, { 0, n+1, n/2, n });
	sprite->SetAnimationDelay((int)PlayerAnim::IDLE_LEFT, ANIM_DELAY);
	sprite->AddKeyFrame((int)PlayerAnim::IDLE_LEFT, { 0, n+1, -n/2, n });

	sprite->SetAnimationDelay((int)PlayerAnim::WALKING_RIGHT, ANIM_DELAY);
	for (i = 1; i < 3; ++i)
		sprite->AddKeyFrame((int)PlayerAnim::WALKING_RIGHT, { (float)8+i*n, n+1, n, n });
	sprite->SetAnimationDelay((int)PlayerAnim::WALKING_LEFT, ANIM_DELAY);
	for (i = 1; i < 3; ++i)
		sprite->AddKeyFrame((int)PlayerAnim::WALKING_LEFT, { (float)8+i*n, n+1, -n, n });

	sprite->SetAnimationDelay((int)PlayerAnim::FALLING_RIGHT, ANIM_DELAY);
	sprite->AddKeyFrame((int)PlayerAnim::FALLING_RIGHT, { 0, n+1, n/2, n });
	sprite->AddKeyFrame((int)PlayerAnim::FALLING_RIGHT, { 0, n+1, n/2, n });
	sprite->SetAnimationDelay((int)PlayerAnim::FALLING_LEFT, ANIM_DELAY);
	sprite->AddKeyFrame((int)PlayerAnim::FALLING_LEFT, { 0, n + 1, -n / 2, n });
	sprite->AddKeyFrame((int)PlayerAnim::FALLING_LEFT, { 0, n + 1, -n / 2, n });
