...
void TileMap::InitTileDictionary()
{
	...
	dict_rect[(int)Tile::ITEM_APPLE] = { 4 * n, 4 * n, n, n };
	dict_rect[(int)Tile::ITEM_CHILI] = { 4 * n, 5 * n, n, n };
	dict_rect[(int)Tile::PLOMA] = { 4 * n, 4 * n, n, n };
	dict_rect[(int)Tile::MELO] = { 5 * n, 4 * n, n, n };
}
